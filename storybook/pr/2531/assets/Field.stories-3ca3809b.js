import{c as E,j as e}from"./component-2bcf5de3.js";import{B}from"./Button-4359694e.js";import{I as l}from"./Input-44881b40.js";const T="Field",a=E(T),D={title:"Forms/Field",component:a,argTypes:{label:{description:"The label of the field.",control:"text"},error:{description:"The error message of the field.",control:"text"},children:{description:"The form component to render inside the field.",table:{type:{summary:"[InputElement, ButtonElement] | DropdownElement | FileInputElement | InputElement | CheckboxElement"}}}}},t={render:r=>e(a,{...r}),args:{label:"Field label",children:e(l,{name:"input",type:"text",value:"",placeholder:"Input placeholder"})}},n={render:r=>e(a,{...r}),args:{label:"Field label",error:"Field error",children:e(l,{name:"input",type:"text",value:"",placeholder:"Input placeholder"})}},o={render:r=>e(a,{...r}),args:{label:"Field label",children:[e(l,{name:"input",type:"text",value:"",placeholder:"Input placeholder"}),e(B,{type:"submit",children:"Submit"})]}};var p,s,i,d,c;t.parameters={...t.parameters,docs:{...(p=t.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: props => <Field {...props} />,
  args: {
    label: 'Field label',
    children: <Input name="input" type="text" value="" placeholder="Input placeholder" />
  }
...
message.`,...(c=(d=t.parameters)==null?void 0:d.docs)==null?void 0:c.description}}};var m,u,h,b,f;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`{
  ...
  args: {
    label: 'Field label',
    children: [<Input name="input" type="text" value="" placeholder="Input placeholder" />, <Button type="submit">Submit</Button>]
  }
