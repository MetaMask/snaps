...
different icon depending on the variant.`,...(D=(W=s.parameters)==null?void 0:W.docs)==null?void 0:D.description}}};var S,C,B,F,I;i.parameters={...i.parameters,docs:{...(S=i.parameters)==null?void 0:S.docs,source:{originalSource:`{
  name: 'With address',
  render: props => <Row {...props} />,
  args: {
    label: 'Label',
...
}`,...(B=(C=i.parameters)==null?void 0:C.docs)==null?void 0:B.source},description:{story:"A row with an address.",...(I=(F=i.parameters)==null?void 0:F.docs)==null?void 0:I.description}}};const q=["Default","Warning","Critical","Tooltip","WithAddress"];export{n as Critical,a as Default,s as Tooltip,o as Warning,i as WithAddress,q as __namedExportsOrder,Y as default};
