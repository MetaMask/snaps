...
export interface SnapRuntimeData {
  ...
  interpreter: Interpreter<
    ...
    ResolveTypegenMeta<TypegenDisabled, SnapEvent, BaseActionObject, ServiceMap>
  >;
}
...
> {
  ...
  private _createMachine({
    ...
    return interpret(snapMachine).start(state);
  }
