import { BaseControllerV2 as BaseController, RestrictedControllerMessenger, HasPermission, GetPermissions } from '@metamask/controllers';
import { SnapId, CronjobSpecification } from '@metamask/snap-utils';
import { GetAllSnaps, GetSnap, HandleSnapRequest, SnapAdded, SnapBlocked, SnapInstalled, SnapRemoved, SnapTerminated, SnapUnblocked, SnapUpdated } from '..';
import { Timer } from '../snaps/Timer';
export declare type CronjobControllerActions = GetAllSnaps | GetSnap | HandleSnapRequest | HasPermission | GetPermissions;
export declare type CronjobControllerEvents = SnapAdded | SnapBlocked | SnapInstalled | SnapRemoved | SnapUnblocked | SnapUpdated | SnapTerminated;
