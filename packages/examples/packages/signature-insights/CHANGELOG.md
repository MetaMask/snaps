...
- chore: Convert remaining examples to JSX ([#3860](https://github.com/MetaMask/snaps/pull/3860))
...
- Add signature insights example ([#2114](https://github.com/MetaMask/snaps/pull/2114))
