...
- Update permission in `transaction-insights` example ([#1997](https://github.com/MetaMask/snaps-skunkworks.git/pull/1997))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/insights-example-snap@2.2.1...HEAD
