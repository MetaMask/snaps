...
- Add `Tooltip` to JSX example ([#2498](https://github.com/MetaMask/snaps-skunkworks.git/pull/2498))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/jsx-example-snap@1.0.0...HEAD
