...
- Add a link to confirmation dialog in dialog example snap ([#2112](https://github.com/MetaMask/snaps-skunkworks.git/pull/2112))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/dialog-example-snap@2.1.0...HEAD
