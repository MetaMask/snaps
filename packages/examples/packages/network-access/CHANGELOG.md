...
- Use process execution service for network access example ([#2177](https://github.com/MetaMask/snaps-skunkworks.git/pull/2177))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/network-example-snap@2.1.1...HEAD
