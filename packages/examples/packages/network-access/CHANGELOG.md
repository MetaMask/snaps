...
- Use process execution service for network access example ([#2177](https://github.com/MetaMask/snaps/pull/2177))
...
[Unreleased]: https://github.com/MetaMask/snaps/compare/@metamask/network-example-snap@2.1.1...HEAD
