  ...
  return function () {
    ...
    3: [function (require, module, exports) {
      ...
      function getEthProviderError(code, arg) {
        const [message, data] = parseOpts(arg);
        return new (0, _chunk77LIU62Ijs.EthereumProviderError)(code, _nullishCoalesce(message, () => _chunkLIUXO4DWjs.getMessageFromCode.call(void 0, code)), data);
      }
    ...
    100: [function (require, module, exports) {
      ...
      var ComponentStruct = (0, import_superstruct15.union)([CopyableStruct, DividerStruct, HeadingStruct, ImageStruct, PanelStruct, SpinnerStruct, TextStruct, RowStruct, AddressStruct, InputStruct, FormStruct, ButtonStruct]);
      ...
      async function getRawImageData(url, options) {
        ...
        return fetch(url, options).then(async response => {
          ...
          (0, import_utils5.assert)(blob.type === "image/jpeg" || blob.type === "image/png", "Expected image data to be a JPEG or PNG image.");
          return blob;
        });
      }
      ...
      async function getImageComponent(url, {
        ...
        (0, import_utils5.assert)(typeof width === "number" && width > 0, "Expected width to be a number greater than 0.");
        (0, import_utils5.assert)(typeof height === "number" && height > 0, "Expected height to be a number greater than 0.");
      ...
      var BoxChildStruct = nullUnion([AddressStruct2, BoldStruct, BoxStruct, ButtonStruct2, CopyableStruct2, DividerStruct2, DropdownStruct, FileInputStruct, FormStruct2, HeadingStruct2, InputStruct2, ImageStruct2, ItalicStruct, LinkStruct, RowStruct2, SpinnerStruct2, TextStruct2, TooltipStruct, CheckboxStruct]);
      var RootJSXElementStruct = BoxChildStruct;
      var JSXElementStruct = nullUnion([ButtonStruct2, InputStruct2, FileInputStruct, FieldStruct, FormStruct2, BoldStruct, ItalicStruct, AddressStruct2, BoxStruct, CopyableStruct2, DividerStruct2, HeadingStruct2, ImageStruct2, LinkStruct, RowStruct2, SpinnerStruct2, TextStruct2, DropdownStruct, OptionStruct, ValueStruct, TooltipStruct, CheckboxStruct, FooterStruct, ContainerStruct]);
