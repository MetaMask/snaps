...
## [1.0.2]
### Uncategorized
- Bump node satisfied version in `create-snap` ([#1789](https://github.com/MetaMask/snaps-skunkworks.git/pull/1789))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/create-snap@1.0.2...HEAD
[1.0.2]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/create-snap@1.0.1...@metamask/create-snap@1.0.2
