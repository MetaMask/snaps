...
## [1.0.1]
### Uncategorized
- Fix Shell command injection in `create-snap` ([#1784](https://github.com/MetaMask/snaps-skunkworks.git/pull/1784))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/create-snap@1.0.1...HEAD
