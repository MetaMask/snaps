  ...
  it('throws on invalid params', async () => {
    ...
    expect(response).toStrictEqual({
      error: {
        code: -32602,
        message:
          'Invalid params: At path: ui -- Expected type to be one of: "AccountSelector", "Address", "AssetSelector", "AddressInput", "Bold", "Box", "Button", "Copyable", "Divider", "Dropdown", "RadioGroup", "Field", "FileInput", "Form", "Heading", "Input", "Image", "Italic", "Link", "Row", "Spinner", "Text", "Tooltip", "Checkbox", "Card", "Icon", "Selector", "Section", "Avatar", "Banner", "Skeleton", "Container", but received: undefined.',
  ...
  it('throws on invalid UI', async () => {
    ...
    expect(response).toStrictEqual({
      error: {
        code: -32602,
        message:
          'Invalid params: At path: ui.props.children.props.children -- Expected type to be one of: "AssetSelector", "AddressInput", "AccountSelector", "Input", "Dropdown", "RadioGroup", "FileInput", "Checkbox", "Selector", but received: "Copyable".',
        stack: expect.any(String),
      },
      id: 1,
      jsonrpc: '2.0',
