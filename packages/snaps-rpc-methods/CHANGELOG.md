...
## [4.1.0]
### Uncategorized
- Remove dead code in `snaps-rpc-methods` ([#2050](https://github.com/MetaMask/snaps-skunkworks.git/pull/2050))
...
- Add `wallet_getAllSnaps` method to get all installed Snaps ([#2047](https://github.com/MetaMask/snaps-skunkworks.git/pull/2047))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-rpc-methods@4.1.0...HEAD
