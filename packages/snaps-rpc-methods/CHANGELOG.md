...
## [4.0.3]
### Uncategorized
- Use prototype `startsWith` for middleware ([#2035](https://github.com/MetaMask/snaps-skunkworks.git/pull/2035))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-rpc-methods@4.0.3...HEAD
