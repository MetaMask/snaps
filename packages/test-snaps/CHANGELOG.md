...
- Add images example to test-snaps page ([#2206](https://github.com/MetaMask/snaps-skunkworks.git/pull/2206))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/test-snaps@2.4.0...HEAD
