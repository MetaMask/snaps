...
- fix: `span` element inside `button` causes test flakiness in extension repo e2e, interfering with the click and scroll actions ([#2782](https://github.com/MetaMask/snaps/pull/2782))
