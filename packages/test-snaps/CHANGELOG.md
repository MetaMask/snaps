...
- fix: Add track event button to `test-snaps` ([#3550](https://github.com/MetaMask/snaps/pull/3550))
...
[Unreleased]: https://github.com/MetaMask/snaps/compare/@metamask/test-snaps@2.28.0...HEAD
