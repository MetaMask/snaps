...
- Fix snap install versioning ([#1387](https://github.com/MetaMask/snaps/pull/1387))
- Add subjectType restrictions to snap-specific permissions ([#1366](https://github.com/MetaMask/snaps/pull/1366))
