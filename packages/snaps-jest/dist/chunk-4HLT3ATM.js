...
async function getInterfaceApi(result, snapId, controllerMessenger) {
  ...
  if (interfaceId) {
    return () => {
      ...
      const actions = _chunkT67MAQQ7js.getInterfaceActions.call(void 0, snapId, controllerMessenger, {
        id: interfaceId,
        content
      });
      return {
...
//# sourceMappingURL=chunk-4HLT3ATM.js.map