 ...
 */
export declare function getInterfaceResponse(runSaga: RunSagaFunction, type: DialogApprovalTypes[DialogType], content: JSXElement, interfaceActions: SnapInterfaceActions): SnapInterface;
/**
