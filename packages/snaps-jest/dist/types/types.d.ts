 ...
 */
export declare type DefaultSnapInterfaceWithFooter = {
    /**
 ...
 */
export declare type DefaultSnapInterfaceWithPartialFooter = DefaultSnapInterfaceWithFooter & {
    /**
     * Cancel the dialog.
     */
    cancel(): Promise<void>;
 ...
 */
export declare type DefaultSnapInterfaceWithoutFooter = DefaultSnapInterfaceWithPartialFooter & {
    /**
     * Close the dialog.
     *
     */
...
export declare type DefaultSnapInterface = DefaultSnapInterfaceWithFooter | DefaultSnapInterfaceWithPartialFooter | DefaultSnapInterfaceWithoutFooter;
export declare type SnapInterface = (SnapAlertInterface | SnapConfirmationInterface | SnapPromptInterface | DefaultSnapInterface) & SnapInterfaceActions;
