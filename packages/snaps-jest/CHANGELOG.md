...
- fix: properly handle invalid interfaces during test ([#2433](https://github.com/MetaMask/snaps-skunkworks.git/pull/2433))
...
- fix: properly diff when using legacy UI with `toRender` matcher ([#2432](https://github.com/MetaMask/snaps-skunkworks.git/pull/2432))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-jest@8.0.0...HEAD
