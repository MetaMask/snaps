...
- [BREAKING] Add `snap_resolveInterface` RPC method ([#2509](https://github.com/MetaMask/snaps-skunkworks.git/pull/2509))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-jest@8.2.0...HEAD
