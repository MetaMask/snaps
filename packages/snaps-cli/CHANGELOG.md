...
- fix: Ignore query strings when parsing URLs ([#2883](https://github.com/MetaMask/snaps-skunkworks.git/pull/2883))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-cli@6.5.3...HEAD
