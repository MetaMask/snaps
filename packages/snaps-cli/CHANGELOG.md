...
- Hide browserlist warning in the CLI ([#2664](https://github.com/MetaMask/snaps-skunkworks.git/pull/2664))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-cli@6.3.1...HEAD
