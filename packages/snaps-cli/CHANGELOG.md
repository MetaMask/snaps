...
## [2.0.1]
### Uncategorized
- Disable fullySpecified rule for `.js` imports in the default Webpack config ([#1780](https://github.com/MetaMask/snaps-skunkworks.git/pull/1780))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-cli@2.0.1...HEAD
