...
## [0.10.2]
### Fixed
- Fix installation failure ([#279](https://github.com/MetaMask/snaps-skunkworks/pull/279))
  - A faulty `postinstall` script was added in [0.10.0] that caused installation to fail for consumers.
