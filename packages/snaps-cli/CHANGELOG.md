...
## [2.0.2]
### Uncategorized
- Use `require.resolve` for `swc-loader` to fix build issue ([#1798](https://github.com/MetaMask/snaps-skunkworks.git/pull/1798))
- Check minimum Node version in CLI ([#1797](https://github.com/MetaMask/snaps-skunkworks.git/pull/1797))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-cli@2.0.2...HEAD
