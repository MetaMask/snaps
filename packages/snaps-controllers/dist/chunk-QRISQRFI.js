...
var AbstractExecutionService = class {
  ...
  async terminate(jobId) {
    ...
    try {
      const result = await _chunkB6KTRDBKjs.withTimeout.call(void 0, 
        this.command(jobId, {
          jsonrpc: "2.0",
          method: "terminate",
          params: [],
      ...
      if (result === _chunkB6KTRDBKjs.hasTimedOut || result !== "OK") {
  ...
  async initStreams(jobId, timer) {
    const result = await _chunkB6KTRDBKjs.withTimeout.call(void 0, this.initEnvStream(jobId), timer);
  ...
  async executeSnap({
    ...
    if (_chunkEXN2TFDJjs.__privateGet.call(void 0, this, _usePing)) {
      const pingResult = await _chunkB6KTRDBKjs.withTimeout.call(void 0, 
        this.command(job.id, {
          jsonrpc: "2.0",
          method: "ping",
          id: _nanoid.nanoid.call(void 0, )
      ...
      if (pingResult === _chunkB6KTRDBKjs.hasTimedOut) {
        throw new Error("The Snaps execution environment failed to start.");
      }
    }
...
//# sourceMappingURL=chunk-QRISQRFI.js.map