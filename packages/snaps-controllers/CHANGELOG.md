...
- Add missing types for `getState` action & `stateChange` event ([#2659](https://github.com/MetaMask/snaps-skunkworks.git/pull/2659))
- fix(snaps-registry): Define missing `getState` action, `stateChange` event ([#2655](https://github.com/MetaMask/snaps-skunkworks.git/pull/2655))
- fix: Fix fetch binding under LavaMoat ([#2642](https://github.com/MetaMask/snaps-skunkworks.git/pull/2642))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-controllers@9.5.0...HEAD
