...
- fix: use first dropdown option as the default value ([#2465](https://github.com/MetaMask/snaps-skunkworks.git/pull/2465))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-controllers@8.3.1...HEAD
