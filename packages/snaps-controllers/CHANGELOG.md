...
- fix: Reinitialize `SnapController` after clearing state ([#3870](https://github.com/MetaMask/snaps/pull/3870))
- chore!: Remove deprecated UI builders ([#3859](https://github.com/MetaMask/snaps/pull/3859))
- chore: Use `JsonRpcEngineV2` for execution services ([#3857](https://github.com/MetaMask/snaps/pull/3857))
- fix: Increase max listeners for `rpcStream` ([#3856](https://github.com/MetaMask/snaps/pull/3856))
