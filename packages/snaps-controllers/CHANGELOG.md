...
- Bump @metamask/phishing-controller from 8.0.0 to 8.0.1 ([#2067](https://github.com/MetaMask/snaps-skunkworks.git/pull/2067))
- Bump @metamask/json-rpc-engine from 7.3.0 to 7.3.1 ([#2065](https://github.com/MetaMask/snaps-skunkworks.git/pull/2065))
- Bump @metamask/approval-controller from 5.1.0 to 5.1.1 ([#2061](https://github.com/MetaMask/snaps-skunkworks.git/pull/2061))
- Remove support for object-like syntax for Cronjobs ([#2057](https://github.com/MetaMask/snaps-skunkworks.git/pull/2057))
- Bump @metamask/approval-controller from 5.0.0 to 5.1.0 ([#2053](https://github.com/MetaMask/snaps-skunkworks.git/pull/2053))
- Revert usage of `DecompressionStream` ([#2052](https://github.com/MetaMask/snaps-skunkworks.git/pull/2052))
- Refactor `NpmLocation` class ([#2038](https://github.com/MetaMask/snaps-skunkworks.git/pull/2038))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-controllers@3.6.0...HEAD
