...
## [10.0.0]
### Added
- **BREAKING:** Add `snap_resolveInterface` RPC method to the `SnapInterfaceController` ([#2509](https://github.com/metamask/snaps/pull/2509))
...
- Bump `@metamask/snaps-utils` from `^7.7.0` to `^7.8.0`
...
[10.0.0]: https://github.com/metamask/snaps/compare/@metamask/snaps-controllers@9.2.0...@metamask/snaps-controllers@10.0.0
