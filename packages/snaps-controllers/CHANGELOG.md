...
- feat: Add `SnapInsightsController` ([#2555](https://github.com/metamask/snaps/pull/2555))
- fix: Account for revoked origins in `initialConnections` ([#2535](https://github.com/metamask/snaps/pull/2535))
- fix: Enforce stricter size limits for source code and auxiliary files ([#2527](https://github.com/metamask/snaps/pull/2527))
- [BREAKING] Add `snap_resolveInterface` RPC method ([#2509](https://github.com/metamask/snaps/pull/2509))
