...
- Set name for `SnapController` ([#3052](https://github.com/MetaMask/snaps-skunkworks.git/pull/3052))
...
- Add getRunnableSnaps method to SnapController ([#3049](https://github.com/MetaMask/snaps-skunkworks.git/pull/3049))
