...
- Rename hideHeader flag to hideSnapBranding ([#2717](https://github.com/MetaMask/snaps/pull/2717))
- Bump `ts-bridge` to `0.5.1` ([#2714](https://github.com/MetaMask/snaps/pull/2714))
- feat: add `hideHeader` flag for preinstalled Snaps ([#2713](https://github.com/MetaMask/snaps/pull/2713))
