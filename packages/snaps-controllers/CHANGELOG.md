...
- perf: Unload iframe before removing ([#3796](https://github.com/MetaMask/snaps/pull/3796))
- fix: Ensure multiplex is destroyed ([#3795](https://github.com/MetaMask/snaps/pull/3795))
