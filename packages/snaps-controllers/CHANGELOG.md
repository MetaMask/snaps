...
## [3.4.1]
### Uncategorized
- Fix a few issues with passing non-serializable JSON ([#1974](https://github.com/MetaMask/snaps-skunkworks.git/pull/1974))
- Bump several MetaMask dependencies ([#1964](https://github.com/MetaMask/snaps-skunkworks.git/pull/1964))
- Bump @metamask/approval-controller from 4.0.0 to 4.1.0 ([#1961](https://github.com/MetaMask/snaps-skunkworks.git/pull/1961))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-controllers@3.4.1...HEAD
