...
- feat: Add non-fungible assets support to `endowment:assets` ([#3527](https://github.com/MetaMask/snaps/pull/3527))
- feat: Add feature flag to treat local Snaps as preinstalled ([#3523](https://github.com/MetaMask/snaps/pull/3523))
