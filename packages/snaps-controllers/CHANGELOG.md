...
## [3.1.0]
### Uncategorized
- Try to match requested version with an allowlisted version ([#1877](https://github.com/MetaMask/snaps-skunkworks.git/pull/1877))
- Improve performance when installing snaps with a static version ([#1878](https://github.com/MetaMask/snaps-skunkworks.git/pull/1878))
...
- Stop persisting snaps in the installing state ([#1876](https://github.com/MetaMask/snaps-skunkworks.git/pull/1876))
- Add origin parameter to `snapInstalled` and `snapUpdated` events ([#1867](https://github.com/MetaMask/snaps-skunkworks.git/pull/1867))
...
- Bump `tar-stream` to the latest version ([#1853](https://github.com/MetaMask/snaps-skunkworks.git/pull/1853))
- Fix documentation typos ([#1847](https://github.com/MetaMask/snaps-skunkworks.git/pull/1847))
...
- Make `snaps-execution-environments` an optional peer dependency ([#1845](https://github.com/MetaMask/snaps-skunkworks.git/pull/1845))
- Remove snap errors from state ([#1837](https://github.com/MetaMask/snaps-skunkworks.git/pull/1837))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-controllers@3.1.0...HEAD
