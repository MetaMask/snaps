...
- Add mutex to `getSnapState` to prevent concurrent decryption ([#3234](https://github.com/MetaMask/snaps-skunkworks.git/pull/3234))
- chore(deps): bump @metamask/key-tree from 10.1.0 to 10.1.1 ([#3254](https://github.com/MetaMask/snaps-skunkworks.git/pull/3254))
- chore: Refactor stateful component check in `constructState` ([#3251](https://github.com/MetaMask/snaps-skunkworks.git/pull/3251))
- Add `AddressInput` component ([#3129](https://github.com/MetaMask/snaps-skunkworks.git/pull/3129))
- fix: Increase Snap interface context size limit slightly ([#3246](https://github.com/MetaMask/snaps-skunkworks.git/pull/3246))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-controllers@11.0.1...HEAD
