...
- BREAKING: Remove `:snapAdded` event ([#2073](https://github.com/MetaMask/snaps-skunkworks.git/pull/2073))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-controllers@4.0.0...HEAD
