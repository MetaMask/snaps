...
- fix: properly handle termination of Snaps while executing ([#2304](https://github.com/MetaMask/snaps-skunkworks.git/pull/2304))
- fix: properly tear down partially initialized executors ([#2348](https://github.com/MetaMask/snaps-skunkworks.git/pull/2348))
- fix: gracefully handle errors for multiple failing requests ([#2346](https://github.com/MetaMask/snaps-skunkworks.git/pull/2346))
- fix: account for caveats in permissions difference calculation ([#2345](https://github.com/MetaMask/snaps-skunkworks.git/pull/2345))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-controllers@7.0.1...HEAD
