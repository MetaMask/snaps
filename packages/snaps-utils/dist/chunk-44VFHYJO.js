...
var evalWrapper = _core.template.statement(`
  (1, REF)(ARGS)
`);
var objectEvalWrapper = _core.template.statement(`
  (1, OBJECT.REF)
`);
var regeneratorRuntimeWrapper = _core.template.statement(`
...
function breakTokensTemplateLiteral(value) {
  ...
  if (matches.length > 0) {
    const output = matches.reduce(
      ([elements, expressions], rawMatch, index, values) => {
        ...
        return [
          [
            ...elements,
            _types.templateElement.call(void 0, {
              raw: getRawTemplateValue(prefix),
              cooked: prefix
            }),
            EMPTY_TEMPLATE_ELEMENT
          ],
          [...expressions, _types.stringLiteral.call(void 0, first), _types.stringLiteral.call(void 0, last)]
        ];
      },
      [[], []]
    );
    ...
    return [
      [
        ...output[0],
        _types.templateElement.call(void 0, { raw: getRawTemplateValue(suffix), cooked: suffix })
      ],
      output[1]
    ];
  }
  return [
    [_types.templateElement.call(void 0, { raw: getRawTemplateValue(value), cooked: value })],
    []
  ];
}
...
function postProcessBundle(code, {
  ...
  const visitor = {
    ...
    TemplateLiteral(path) {
      ...
      path.replaceWith(
        _types.templateLiteral.call(void 0, 
          replacementQuasis,
    ...
    StringLiteral(path) {
      ...
      const replacement = tokens.slice(1).reduce(
        (acc, value) => _types.binaryExpression.call(void 0, "+", acc, _types.stringLiteral.call(void 0, value)),
        _types.stringLiteral.call(void 0, tokens[0])
      );
    ...
    BinaryExpression(path) {
      ...
      if (node.operator === "<" && _types.isUnaryExpression.call(void 0, node.right) && _types.isUpdateExpression.call(void 0, node.right.argument) && node.right.argument.operator === "--" && node.left.end && node.right.argument.argument.start) {
      ...
      if (node.operator === ">" && _types.isUpdateExpression.call(void 0, node.left) && node.left.operator === "--" && node.left.argument.end && node.right.start) {
  ...
  try {
    const file = _core.transformSync.call(void 0, code, {
