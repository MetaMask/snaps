...
var _chunkQGCNQRIQjs = require('./chunk-QGCNQRIQ.js');
...
function assertIsSnapIcon(icon) {
  ...
  _utils.assert.call(void 0, _chunkQGCNQRIQjs.isSvg.call(void 0, icon.toString()), "Snap icon must be a valid SVG.");
}
function getSvgDimensions(svg) {
  try {
    const parsed = _chunkQGCNQRIQjs.parseSvg.call(void 0, svg);
...
//# sourceMappingURL=chunk-W7KRIAIX.js.map