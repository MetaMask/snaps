...
- Fix missing `global` in eval-worker ([#2072](https://github.com/MetaMask/snaps-skunkworks.git/pull/2072))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-utils@5.1.2...HEAD
