...
- Fix issues with using proxy executors ([#2045](https://github.com/MetaMask/snaps-skunkworks.git/pull/2045))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-utils@5.1.1...HEAD
