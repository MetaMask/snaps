...
## [5.1.0]
### Uncategorized
- Upstream derivation path logic from the extension client ([#2033](https://github.com/MetaMask/snaps-skunkworks.git/pull/2033))
- Bump `snaps-registry` ([#2020](https://github.com/MetaMask/snaps-skunkworks.git/pull/2020))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-utils@5.1.0...HEAD
