...
- Add connections diff calculations needed for Snap update ([#2424](https://github.com/MetaMask/snaps-skunkworks.git/pull/2424))
- Bump @metamask/post-message-stream from 8.0.0 to 8.1.0 ([#2421](https://github.com/MetaMask/snaps-skunkworks.git/pull/2421))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-utils@7.4.0...HEAD
