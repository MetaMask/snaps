...
- Add initialConnections to requestState ([#2322](https://github.com/MetaMask/snaps-skunkworks.git/pull/2322))
...
- Bump @metamask/snaps-registry from 3.0.1 to 3.1.0 ([#2302](https://github.com/MetaMask/snaps-skunkworks.git/pull/2302))
