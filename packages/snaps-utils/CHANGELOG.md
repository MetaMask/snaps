...
- feat: Add IOTA derivation path ([#3653](https://github.com/MetaMask/snaps/pull/3653))
...
- chore: Bump @metamask/slip44 from 4.2.0 to 4.3.0 ([#3629](https://github.com/MetaMask/snaps/pull/3629))
