...
- Change types to allow regular array types as children ([#2470](https://github.com/MetaMask/snaps-skunkworks.git/pull/2470))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-utils@7.6.0...HEAD
