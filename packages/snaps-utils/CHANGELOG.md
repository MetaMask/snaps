...
- Move `file` struct to CLI ([#2207](https://github.com/MetaMask/snaps-skunkworks.git/pull/2207))
- Add sizing limits for custom UI ([#2199](https://github.com/MetaMask/snaps-skunkworks.git/pull/2199))
- Validate links contained in rows ([#2205](https://github.com/MetaMask/snaps-skunkworks.git/pull/2205))
- Fix VirtualFile import in browser contexts ([#2204](https://github.com/MetaMask/snaps-skunkworks.git/pull/2204))
