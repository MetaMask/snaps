...
- Use lexer for extraction of markdown links ([#2261](https://github.com/MetaMask/snaps-skunkworks.git/pull/2261))
- Bump `@metamask/snaps-registry` to `^3.0.1` ([#2255](https://github.com/MetaMask/snaps-skunkworks.git/pull/2255))
