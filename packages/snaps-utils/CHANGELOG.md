...
- feat: add hidden flag for preinstalled Snaps ([#2463](https://github.com/MetaMask/snaps-skunkworks.git/pull/2463))
- feat: allow wildcards in `allowedOrigins` ([#2458](https://github.com/MetaMask/snaps-skunkworks.git/pull/2458))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-utils@7.5.0...HEAD
