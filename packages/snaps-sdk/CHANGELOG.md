...
- Re-introduce expanded view notifications via `snap_notify` ([#2881](https://github.com/MetaMask/snaps-skunkworks.git/pull/2881))
- chore: Update comments referencing extension main branch ([#2921](https://github.com/MetaMask/snaps-skunkworks.git/pull/2921))
