...
- Strip empty data from snap errors ([#2179](https://github.com/MetaMask/snaps-skunkworks.git/pull/2179))
- Improve support for Snap errors without a message ([#2176](https://github.com/MetaMask/snaps-skunkworks.git/pull/2176))
