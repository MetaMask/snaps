...
- Add support for array `key` parameter in `SetStateParams` for `snap_setState`

## [12.0.1]

### Fixed

- Sync `PrivateKeyEncoding` type with `@metamask/keyring-api` ([#4104](https://github.com/MetaMask/snaps/pull/4104))
...
- Add `CollapsibleSection` component ([#3952](https://github.com/MetaMask/snaps/pull/3952))
- Add types for `KeyringCapabilities` ([#3903](https://github.com/MetaMask/snaps/pull/3903))
