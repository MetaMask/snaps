 ...
 * one of the structs.
 */
export declare function nullUnion<Head extends AnyStruct, Tail extends AnyStruct[]>(structs: [head: Head, ...tail: Tail]): Struct<Infer<Head> | InferStructTuple<Tail, Tail["length"]>[number], null>;
export {};
