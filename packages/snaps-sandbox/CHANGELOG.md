...
- chore: Use Geist font for Snaps Sandbox ([#3892](https://github.com/MetaMask/snaps/pull/3892))
...
- chore: Bump the npm_and_yarn group across 2 directories with 3 updates ([#3787](https://github.com/MetaMask/snaps/pull/3787))
