...
- Remove code duplication in LavaMoat build script ([#2564](https://github.com/MetaMask/snaps/pull/2564))
- feat: Inline WebView bundle ([#2528](https://github.com/MetaMask/snaps/pull/2528))
