...
- perf: Remove unnecessary proxy for provider globals ([#2850](https://github.com/MetaMask/snaps-skunkworks.git/pull/2850))
- fix: Make `ResponseWrapper` an instance of `Response` ([#2889](https://github.com/MetaMask/snaps-skunkworks.git/pull/2889))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-execution-environments@6.9.2...HEAD
