...
- Bump `@metamask/providers` to `^15.0.0` ([#2231](https://github.com/MetaMask/snaps-skunkworks.git/pull/2231))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-execution-environments@5.0.3...HEAD
