...
## [2.0.1]
### Uncategorized
- Remove unmaintained OpenRPC doc for execution environment ([#1782](https://github.com/MetaMask/snaps-skunkworks.git/pull/1782))
- Allow passing `undefined` parameters to `request()` ([#1776](https://github.com/MetaMask/snaps-skunkworks.git/pull/1776))
- Bump SES ([#1777](https://github.com/MetaMask/snaps-skunkworks.git/pull/1777))
- Update LavaMoat ([#1754](https://github.com/MetaMask/snaps-skunkworks.git/pull/1754))
- Fix an issue where errors would not correctly be returned ([#1772](https://github.com/MetaMask/snaps-skunkworks.git/pull/1772))
...
[Unreleased]: https://github.com/MetaMask/snaps-skunkworks.git/compare/@metamask/snaps-execution-environments@2.0.1...HEAD
